...
public class Generics {
    ...
    public <T extends BigBox> boolean checkBoxInList(List<BigBox> list, BigBox item) {
    ...
    public static <T extends BigBox> void addBox(List<BigBox> list, BigBox item) {
        list.add(item);
    }
    ...
    <T extends MediumBox> void print(List<T> list) {
        for (T t1 : list) {
...
//    }
    public static <T extends BigBox> void copy(List<T> list1, List<T> list2) {         //в лист1 копируются элементы лист2
        list1.addAll(list2);
    }
